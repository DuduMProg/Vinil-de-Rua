...
<body>
    ...
    <main>
        <div class="conteiner">
            ...
            {{-- Banner editorial diagonal — inferior esquerdo --}}
            <div class="bannerEditorial">
                <span class="bannerSup">Vinil de Rua — Categoria</span>
                <span class="bannerNome">{{ strtoupper($category->name) }}</span>
                <a class="bannerInf" href="#catalogoCategoria">
                    <span class="discoSm"></span>
                    Explorar coleção
                </a>
            </div>
    ...
    <section class="fundoPrincipal">
        ...
        <div class="outrasCategorias">
            ...
            <div class="categorias">
                ...
                @foreach($categories as $c)
                    ...
                    @if($c->id != $category->id)
                        <a href="{{ route('category.show', $c->id) }}" class="catPill">
                            <span class="discoIcon"></span>
                            {{ $c->name }}
                        </a>
                    @endif
        ...
        <div class="waveTransicao">
            <svg viewBox="0 0 1440 80" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none"
                style="width:100%;display:block">
                <path d="M0,0 C360,80 1080,0 1440,60 L1440,80 L0,80 Z" fill="#515151" />
            </svg>
        </div>

        <section class="catalogoCategoria" id="catalogoCategoria">
            ...
            @forelse($products as $p)
                ...
                {{-- Card clicável que leva à página do produto --}}
