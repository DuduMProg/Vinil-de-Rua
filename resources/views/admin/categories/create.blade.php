...
<head>
    ...
    <title>Nova Categoria - ADM</title>
...
<div class="painelAdmin">
    ...
    <aside class="menuLateral">
        ...
        <div class="menuCategorias">
            ...
            <ul>
                ...
                <li><a href="/admin/category/create" class="linkMenuCat ativo">+ Nova categoria</a></li>
            </ul>
    ...
    <main class="conteudoPrincipal">
        ...
        <section class="secaoProdutos">
            <h1 class="tituloSecao">Nova Categoria</h1>
                ...
                <div class="formsNovoProduto">
                    <form action="/admin/category" method="POST">
                        ...
                        <div class="infoForms">
                            ...
                            <input type="text" name="name" placeholder="Ex: Grime, Boombap..." value="{{ old('name') }}" required>
                        </div>

                        <div class="infoForms">
                            <label>Banner (URL):</label>
                            <input type="text" name="banner" placeholder="https://..." value="{{ old('banner') }}">
                        </div>
